...
%global scl_name_base git
%global scl_name_version 212
...
the necessary packages to use git-2.12. Software collections allow
to install more versions of the same package by using an alternative
directory structure.
Install this package if you want to use git-2.12 on your system.
...
%changelog
* Tue Apr 11 2017 Jaroslaw Polok <jaroslaw.polok@cern.ch> 1.0-1
- reused spec for git212 sclo.
